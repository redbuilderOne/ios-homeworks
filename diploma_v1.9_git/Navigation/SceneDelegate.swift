...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createProfileNavigationController() -> UINavigationController {
        ...
        loginViewController.tabBarItem.image = UIImage(named: "icons8-iOS Glyph-Cat Profile 2")
        loginViewController.tabBarItem.selectedImage = UIImage(named: "icons8-iOS Glyph-Cat Profile")
